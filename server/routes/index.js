...
router.get('/', function(req, res, next) {
  res.render('index', { title: 'Express', content: `여섯 살 적에 나는 "체험한 이야기"라는 제목의, 원시림에 관한 책에서 기막힌 그림 하나를 본 적이 있다. 맹수를 집어삼키고 있는 보아 구렁이 그림이었다. 위의 그림은 그것을 옮겨 그린 것이다.
  그 책에는 이렇게 씌어 있었다.
 ...
 어린 왕자는 속으로 중얼거렸다. 그래서 그는 다시 두 손을 마주 두드렸다.허영심 많은 사람이 모자를 들어올리며 다시 답례를 했다.오 분쯤 되풀이하고 나니 어린 왕자는 그 장난이 재미없어졌다.
  ...
  "그러면 아저씨 것이 되는 거야?"
  "물론이지. 임자 없는 다이아몬드는 그걸 발견한 사람의 소유가 되는 거지 임자가 없는 섬을 네가 발견하면 그건 네 소유가 되는 거고. 네가 어떤 좋 은 생각을 제일 먼저 해냈으면 특허를 맡아야 해.그럼 그것이 네 소유가 되는 거야. 그래서 나는 별들을 소유하고 있는 거야.나보다 먼저 그것들 을 소유할 생각을 한 사람은 아무도 없었거든."
  "그건 사실이지. 아저씨는 별들을 가지고 뭘 해?"
 어린 왕자가 말했다.
  "그것들을 관리하지. 세어 보고 또 세어 보고 하지.그건 힘드는 일이야. 하지만 나는 진지한 사람이거든!"
  어린 왕자는 그래도 흡족해 하지 않았다.
  "나는 말이야,머플러는 소유하고 있을 때는 그것을 목에 두르고 다닐 수 가 있어.또 꽃을 소유하고 있을 때는 그 꽃을 꺾어 가지고 다닐 수가 있 고, 하지만 아저씨는 별들을 꺾을 수가 없잖아!"
  "그럴 수는 없지. 하지만 그것들을 은행에 맡길 수 있지."
  "그게 무슨 말이야."
  "조그만 종이조각에다내 별들의 숫자를 적어 그것을 서랍에 넣고 잠근단 말이야."
  "그리고 그뿐이야?"
  "그뿐이지."
  (그것 재미있는데. 아주 시적(詩的)이고, 하지만 그리 중요한 일은 아니군)하고 어린 왕자는 생각했다.
  어린 왕자는 중요한 일에 대해서어른들과 매우 다른 생각을 가지고 있었다.
  "나는 말이야, 꽃을 한 송이 소유하고 있는데 매일 물을 줘. 세 개의 화산 도 소유하고 있어서 매주 그을음을 청소해 주고는 하지. 불이 꺼진 화산도 청소해 주니까 세 개란 말이야. 언제 어떻게 될지 알 수 없는 노릇이거든. 내가 그들을 소유하는 건 내 화산들에게나 내 꽃에게 유익한 일이야. 하지 만 아저씨는 별들에게 유익하지 않잖아......"
  실업가는 입을 열어 무슨 말을 하려 했으나 할 말을 찾아 내지 못했다. 그래서 어린 왕자는 떠나 버렸다.
  (어른들은 정말 아주 이상야릇하군) 하고 어린 왕자는 여행하면서 혼자 속으로 중얼거릴 뿐이었다.
  14
  ...
  17
  재치를 부리려다 보면 조금 거짓말을 하는 수가 있다. 가로등 켜는 사람들에 대해 내가 한 이야기는 아주 정직한 것은 못된다.지구를 잘 알지 못하는 사람들에게 자칫하면지구에 대한 잘못된 생각을가지게 할 수도 있을이야기였다. 사람들이 지구 위에서 차지하는 자리란 실은 아주 작은 것이다지구에서 사는 20억의 사람들이 어떤 모임에서처럼서로 좀 바짝바짝 붙어서 있는다면 세로 20마일 가로 20마일의 광장으로도 충분할 것이다. 그들은태평양의 아주 작은 섬 위에 차곡차곡 쌓아 놓을 수도 있을 것이다.
  ...
  꽃이 말했다.
  19
  어린 왕자는 한 높은 산 위로 올라갔다.그가 아는 산이라곤 그의 무릎에닿는 세 개의 화산이 고작이었다.불 꺼진 화산은 걸상으로 이용하곤 했었다.(이 산처럼 높은 산에서는 이 별과 사람들 모두를 한 눈에 볼 수 있을거야......) 그러나 바늘 끝처럼 뾰족뾰족한 산봉우리만 보일 뿐이었다.
  "안녕."
  그가 혹시나 하고 말해 보았다.
  "안녕...... 안녕...... 안녕......"
  메아리가 대답했다.
  ...
  20
  그리하여어린 왕자는 모래와 바위와 눈 가운데를오랫동안 걷고난 끝에드디어 길을 하나 발견했다.그런데 길들이란 모두사람들이 있는 곳으로통하는 법이다.
  "안녕."
  그가 말했다.
  그것은 장미가 만발한 정원이었다.
  "안녕."
  ...
  27
  그러니까 그게 벌써 여섯 해 전의 일이었다......이 이야기를 나는 여태까지 한 번도 하지 않았었다.나와 다시 만나 친구들은내가 살아 돌아온걸 매우 기뻐했다.나는 슬펐지만 피곤 때문에 그렇게 보일 뿐이라고 그들에게 말했다.
  이제는 내 슬픔도 조금 가셨다. 다시 말해......완전히 싹 가셔 버린 것은 아니라는 뜻이다. 하지만 나는 그가 그의 별로 돌아갔다는 걸 알고 있다다음날 해가 떳을 때 그의 몸을 다시 찾아볼 수 없었던 것이다.그의 몸은그리 무겁지 않았다...... 그래서 밤이면 나는 별들에게 귀기울이기를 좋아한다. 그것들은 흡사 5억 개의 작은 방울들 같다...... 그런데 이상한 어떤일이 일어나고 있는 건 아닌가! 어린 왕자에게 그려 준 굴레에 가죽끈을 붙이는 걸 내가 잊어버린 것이다!그걸 양에게 잡아맬도리가 없는 것이다.그래서 나는 (그의 별에서 무슨 일이 일어나고 있을까? 양이 꽃을 먹었을까......)하고 궁금해 하곤 했다.
  어느 때는 (천만에, 먹지 않았겠지! 어린 왕자는 그의 꽃을 밤새도록 유리덮개로 잘 덮어 놓겠지. 양을 잘 지킬 테고......)라고 생각해 본다.그러면 나는 행복해진다. 그러면 뭇별들이 모두 부드럽게 웃는다.
  어느 때는 (한두 번 방심할 수도 있지. 그러면 끝장인데!어느날 밤 그가유리덮개를 잊었거나 양이 밤중에 소리없이 밖으로 나왔을지도 몰라......)하는 생각이 들기도 한다. 그러면 작은 방울들은 모두 눈물방울로 변한다!......
  그것은 정말 커다란 수수께끼다. 어린 왕자를 사랑하는 여러분에게는 나에게도 그렇듯이,이 세상 어딘가에서 우리가 알지 못하는한 마리 양이 한송이 장미꽃을 먹었느냐. 먹지 않았느냐에 따라서 천지가 온통 뒤바뀌게 될것이다.
  하늘을 바라보라. 생각해 보라. 양이 그 꽃을 먹었을까 먹지 않았을까? 그러면 거기에 따라 모든 게 변함을 여러분은 알게 되리라.
  그런데 그것이 그다지도 중요하다는 걸 어른들은 아무도 이해하지 못할 것이다! 이것은 나에게 이 세상에서가장 아름답고 그리고 가장 슬픈 풍경이다. 앞 페이지의 것과 같은 풍경이지만 여러분에게 잘 보여 주기 위해 다시한번 그린 것이다.어린 왕자가 지상에 나타났다가 다시 사라진 곳이 여기다.
  이 그림을 찬찬히 잘 보아두었다가 여러분이 언제고 아프리카 사막을 여행할 때, 이와 똑같은 풍경을 꼭 알아볼 수 있기를 바란다. 그리고 혹시 그리로 지나가게 되면,발걸음을 서두르지 말고 잠깐 별빛 밑에서 기다려 보길간곡히 부탁한다! 그때 만일 한 어린아이가 여러분에게 다가오면,그가 웃고 있고 머리칼이 금빛이면,그리고 묻는 말에 대답을 하지 않으면 여러분은 그가누구인지 알아낼 수 있으리라.그러면 내게 친절을 베풀어 주길!내가 이처럼 마냥 슬퍼하도록 내버려두지 말고 그 애가 돌아왔다고 빨리 편지를 보내 주길......` });
});
